          ...
          <div className="text-center">
            ...
            <div className="mb-6 sm:mb-8">
              ...
              >
                ...
                <motion.span
                  className="relative inline-block gradient-text-large pb-8"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  {heroData.highlight}
                  <motion.div
                    className="absolute left-0 right-0 top-full mt-3 h-1.5 rounded-full bg-gradient-to-r from-secondary via-primary to-accent shadow-[0_0_25px_rgba(147,51,234,0.45)]"
                  ...
                  />
                  <motion.div
                    className="absolute left-0 right-0 top-full mt-3 h-1.5"
                    initial={{ opacity: 0 }}
